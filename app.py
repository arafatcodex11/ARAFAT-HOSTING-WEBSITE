...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "ARAFAT_hosting_secret_key_2024")
...
@app.route('/')
def home():
    return f"<h1>Arafat Hosting Test Server</h1><p>Running at {time.ctime()}</p>"
...
def login():
    ...
    <head>
        ...
        <title>Arafat Hosting | Login</title>
        <style>
    ...
    <body>
        ...
        <div class="login-container">
            <div class="logo">Arafat Hosting</div>
...
if __name__ == "__main__":
    ...
    print(f"""
    ╔══════════════════════════════════════════╗
    ║      Arafat Hosting - Unlimited Servers    ║
